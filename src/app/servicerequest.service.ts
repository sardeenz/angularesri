...
export class ServicerequestService {
  ...
  public user: User;
    ...
    public testSr = {'callerFirstName': 'Surender', 'callerLastName': 'Dalal', 'callerWorkPhone': '9196708062',
    ...
    public formTest =  {'callerfirstname': 'charles', 'callerlastname': 'Foley', 'address': '1413 Scales St',
  ...
  createServiceRequest(user): Observable<string> {
        ...
        return this.http.post(this.srUrl, x, options).map((res: Response) => res.json());
